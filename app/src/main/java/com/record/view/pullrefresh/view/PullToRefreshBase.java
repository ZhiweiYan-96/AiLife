...
import com.record.view.pulltorefresh.library.internal.FlipLoadingLayout;
import com.record.view.pulltorefresh.library.internal.LoadingLayout;
import com.record.view.pulltorefresh.library.internal.RotateLoadingLayout;
import com.record.view.pulltorefresh.library.internal.Utils;
import com.record.view.pulltorefresh.library.internal.ViewCompat;
...
//                    break;
    ...
    public final void onRefreshCompleteDelay(String str, int delay) {
        if (isRefreshing()) {
            if (str != null && str.length() > 0) {
                setRefreshingLabel(str);
            }
...
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PullToRefresh);
        ...
        if (a.hasValue(13)) {
            this.mScrollingWhileRefreshingEnabled = a.getBoolean(13, false);
        }
